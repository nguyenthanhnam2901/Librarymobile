...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recentlyWatchedList.add(new ChildModelClass(R.drawable.book11, "Title", "Author", "Description"));
        recentlyWatchedList.add(new ChildModelClass(R.drawable.book12, "Title", "Author", "Description"));
        recentlyWatchedList.add(new ChildModelClass(R.drawable.book13, "Title", "Author", "Description"));
        recentlyWatchedList.add(new ChildModelClass(R.drawable.book14, "Title", "Author", "Description"));
        recentlyWatchedList.add(new ChildModelClass(R.drawable.book15, "Title", "Author", "Description"));
        recentlyWatchedList.add(new ChildModelClass(R.drawable.book16, "Title", "Author", "Description"));
        recentlyWatchedList.add(new ChildModelClass(R.drawable.book17, "Title", "Author", "Description"));
        recentlyWatchedList.add(new ChildModelClass(R.drawable.book18, "Title", "Author", "Description"));
        recentlyWatchedList.add(new ChildModelClass(R.drawable.book19, "Title", "Author", "Description"));

        parentModelClassArrayList.add(new ParentModelClass("Recently Read", recentlyWatchedList));

        // Add items to favouriteList
        favouriteList.add(new ChildModelClass(R.drawable.book21, "Title", "Author", "Description"));
        favouriteList.add(new ChildModelClass(R.drawable.book22, "Title", "Author", "Description"));
        favouriteList.add(new ChildModelClass(R.drawable.book23, "Title", "Author", "Description"));
        favouriteList.add(new ChildModelClass(R.drawable.book24, "Title", "Author", "Description"));
        favouriteList.add(new ChildModelClass(R.drawable.book25, "Title", "Author", "Description"));
        favouriteList.add(new ChildModelClass(R.drawable.book26, "Title", "Author", "Description"));
        favouriteList.add(new ChildModelClass(R.drawable.book27, "Title", "Author", "Description"));
        favouriteList.add(new ChildModelClass(R.drawable.book28, "Title", "Author", "Description"));
        favouriteList.add(new ChildModelClass(R.drawable.book29, "Title", "Author", "Description"));
        ...
        childModelClassArrayList.add(new ChildModelClass(R.drawable.book30, "Title", "Author", "Description"));
        childModelClassArrayList.add(new ChildModelClass(R.drawable.book21, "Title", "Author", "Description"));
        childModelClassArrayList.add(new ChildModelClass(R.drawable.book13, "Title", "Author", "Description"));
        childModelClassArrayList.add(new ChildModelClass(R.drawable.book4, "Title", "Author", "Description"));
        childModelClassArrayList.add(new ChildModelClass(R.drawable.book25, "Title", "Author", "Description"));
        childModelClassArrayList.add(new ChildModelClass(R.drawable.book6, "Title", "Author", "Description"));
        childModelClassArrayList.add(new ChildModelClass(R.drawable.book17, "Title", "Author", "Description"));
