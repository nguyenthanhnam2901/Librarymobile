...
public class ParentAdapterHorizontal extends RecyclerView.Adapter<ParentAdapterHorizontal.ViewHolder> {

    List<ParentModelClass> parentModelClassList;
    Context context;

    public ParentAdapterHorizontal(List<ParentModelClass> parentModelClassList, Context context) {
    ...
    @NonNull
    @Override
    public ParentAdapterHorizontal.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.parent_rv_layout, null, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ParentAdapterHorizontal.ViewHolder holder, int position) {
